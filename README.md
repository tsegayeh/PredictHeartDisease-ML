...
Upon cleaning and preprocessing the data, explarotary data analysis (EDA) was done. Visualizations from the EDA are presented herein, including: variable tables ([vtables]()), frequency distributions (numeric and categorical variables), and relationships (numeric variables and categories). Upon creation of the models, more visualizations, namely error plots, feature importance, and ROC curves (individual and overlaid) were used to evaluate the performances of the models.<br />
